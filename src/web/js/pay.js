    ...
    require(['jquery','qrcode','global_eddie','socketio','bootstrap'],function(jq,qr,gl,io,bs){
        ...
        $('#settle').click(function(){
            ...
            var qrcode = new QRCode('qrcode', {
                text: "http://10.3.135.17:1337/pay&order/order.html?orderno="+orderno,
                width: 160,
                height: 160,
                colorDark : '#000000',
                colorLight : '#ffffff',
            ...
            socket.on('pay',function(message){
                ...
                $.post('http://10.3.135.67:81/print',{text:obj},function(res){
                    console.log(res);
                })
            })
        })
        ...
        function receipt(data){
            ...
            data.forEach(function(item,idx){
                cont+=`${item.name}     ${item.price}     ${item.qty}\n`   
            }); 
